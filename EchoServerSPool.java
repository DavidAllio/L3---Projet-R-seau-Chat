...
public class EchoServerSPool {
    ...
    public static void main(String[] args) throws IOException{
        ...
        ExecutorService executor = Executors.newFixedThreadPool(nbr_thread);
        ...
        while(true) {
            try {
                ...
                executor.submit(new ClientHandlerSPool(s, inFromClient));
...
class ClientHandlerSPool extends Thread
{
    ...
    // Constructor
    public ClientHandlerSPool(Socket s, DataInputStream dis)
    {
        this.s = s;
        this.dis = dis;
    }
